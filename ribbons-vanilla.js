...
class RibbonsEffect {
  ...
  init() {
    ...
    this.container.addEventListener('touchstart', this.updateMouse);
    this.container.addEventListener('touchmove', this.updateMouse);
  ...
  destroy() {
    ...
    this.container.removeEventListener('mousemove', this.updateMouse);
    this.container.removeEventListener('touchstart', this.updateMouse);
    this.container.removeEventListener('touchmove', this.updateMouse);
